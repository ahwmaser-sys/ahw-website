...
export const faqItems: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'Four core disciplines: Architecture, Interior Design, Design & Build, and Fit-Out — covering everything from master planning and structural/engineering design to space planning, bespoke joinery, construction management, MEP coordination, and authority approvals. Projects span Residential, Commercial, Hospitality, Workplace, and Retail sectors.',
  },
  {
