...
export default async function ArchitecturePage() {
  ...
  const pageUrl = `${siteUrl}/expertise/architecture`;
  ...
  // Same content buildBreadcrumbJsonLd already produced — only adding an
  // @id so WebPage below can reference it, per "keep BreadcrumbList
  // intact."
