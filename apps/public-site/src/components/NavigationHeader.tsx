...
import { Header, type PortfolioNavData } from '@agp/ui-components';

export function NavigationHeader({ portfolioNav }: { portfolioNav: PortfolioNavData }) {
  ...
  return <Header currentPath={pathname} portfolioNav={portfolioNav} />;
}
